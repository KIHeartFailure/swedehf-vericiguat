...
vars <- vars %>%
  mutate(
    ...
    footnote3 = if_else(str_detect(var, "out") & !str_detect(var, "death|hosp"), footnote_marker_alphabet(3, format = "latex"), ""),
    footnote4 = if_else(str_detect(var, "deathcv|deathhf"), footnote_marker_alphabet(4, format = "latex"), ""),
